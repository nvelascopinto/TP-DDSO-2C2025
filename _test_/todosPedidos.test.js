  ...
  beforeEach(() => {
    ...
    describe('crearPedido', () =>{
        ...
        it('deberia no crear el pedido por falta de stock' , () => {
            ...
            const item2 = new Producto(vendedor, "licuadora", "licuadora de frutas", "Electrónica", 100, "PESO_ARG", 1, null, true)
    ...
    describe('cancelarPedido', () => {
        ...
        it('deberia cancelar el pedido por ser el vendedor quien lo hace', () => {
           ...
           mockPedidoRepository.consultar.mockReturnValue(mockPedido)
           ...
           expect(mockPedidoRepository.consultar).toHaveBeenCalledTimes(1)
           expect(mockPedidoRepository.consultar).toHaveBeenCalledWith(1)
    ...
    describe('consultar', () => {
        ...
        it('deberia devolver el pedido solicitado', () => {
            ...
            expect(mockPedidoRepository.consultar).toHaveBeenCalledTimes(1)
            expect(mockPedidoRepository.consultar).toHaveBeenCalledWith(3)
        ...
        it(' no deberia devolver el pedido ya que no existe', () => {
            ...
            mockPedidoRepository.consultar.mockReturnValue(null)
            expect(() => {pedidoService.consultar(2)}).toThrow(PedidoInexistenteError)
            expect(mockPedidoRepository.consultar).toHaveBeenCalledTimes(1)
            expect(mockPedidoRepository.consultar).toHaveBeenCalledWith(2)
    ...
    describe('marcarEnviado', () => {
        ...
        it('debería marcar un pedido como enviado', () => {
            ...
            expect(mockPedidoRepository.consultar).toHaveBeenCalledWith(123)
        
        })
        it('debería tirar PedidoInexistenteError si el pedido no existe', () => {
            mockUsuarioService.obtenerUsuario.mockReturnValue(vendedor)
            mockPedidoRepository.consultar.mockImplementationOnce(null)
