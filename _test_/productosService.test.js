...
describe("ProductosService", () =>{
    ...
    describe("crear", () => {
         ...
         const vendedor =  new Usuario(
            ...
            let productoDTO = new ProductoDTO(2, "auriculares", "Auriculares bluetooth con cancelación de ruido y 20h de batería.", "Electrónica", 15000, "PESO_ARG", 50, null, true )
       
        it("deberia crear el producto pasado", () => {
           
            const mockProducto = new Producto(vendedor, "auriculares", "Auriculares bluetooth con cancelación de ruido y 20h de batería.", "Electrónica", 15000, "PESO_ARG", 50, null, true)
            mockProducto.id = 1
        ...
        it("no deberia crear un producto con stock en 0", () => {
            productoDTO = new ProductoDTO(2, "auriculares", "Auriculares bluetooth con cancelación de ruido y 20h de batería.", "Electrónica", 15000, "PESO_ARG", 0, null, true )
            expect(()=>{productoService.crear(productoDTO)}).toThrow(DatosInvalidos)
            expect(mockProductoRepository.crear)
        })

          it("no deberia crear un producto por tener moneda invalida", () => {
            productoDTO = new ProductoDTO(2, "auriculares", "Auriculares bluetooth con cancelación de ruido y 20h de batería.", "Electrónica", 15000, "PESO_Ur", 50, null, true )
            expect(()=>{productoService.crear(productoDTO)}).toThrow(DatosInvalidos)
        })
          it('No debería crearse el producto por tener un vendedor invalido', () => {
            ...
            productoDTO = new ProductoDTO(100, "auriculares", "Auriculares bluetooth con cancelación de ruido y 20h de batería.", "Electrónica", 15000, "PESO_ARG", 50, null, true )
